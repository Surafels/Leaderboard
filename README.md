...
- [mic-Leaderboard](#mic-leaderboard)
...
**Leaderboard** A leaderboard app designed to track and display rankings or scores of individuals or entities.The app typically provides a centralized platform where users can submit their scores or achievements.
...
```sh
  git clone[https://github.com/Surafels/Leaderboard.git]
```
...
You are welcome, and click <a href="hhttps://github.com/Surafels/Leaderboard/issues">here</a> for any issues🙏
